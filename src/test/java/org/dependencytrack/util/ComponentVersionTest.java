...
public class ComponentVersionTest {
    ...
    public void testIsSemVerVersion(String version) {
        Assert.assertTrue("not semver: " + version, ComponentVersion.isSemVerVersion(version));
    }

    @Test
    @Parameters(method = "paremetersNotSemVerVersions")
    public void testIsNotSemVerVersion(String version) {
        Assert.assertFalse("is semver: " + version, ComponentVersion.isSemVerVersion(version));
    }
